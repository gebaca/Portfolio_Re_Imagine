...
function About() {
  ...
  return (
    <div className='w-full flex flex-col items-center'>
      {/* FONDO — absolute con coordenadas reales del documento */}
      {circleState?.rect && (
        <div
          ref={setBgRef}
          style={{
      ...
      {/* positionY en vh — 100 cubre la pantalla sin generar scroll extra */}
      <CircleSatellites
      ...
      <FadeInParent stagger={1}>
        <div className='relative z-10 w-full max-w-4xl px-6 flex flex-col items-center py-20'>
          ...
          <p className='max-w-2xl text-center text-[1.125rem] leading-[1.8] text-zinc-800 font-medium mb-40'>
            ...
            engaging user experiences. With a background in design and a knack
            for animation, I specialize in crafting visually stunning
            websites...
          </p>
              ...
              <div className='relative'>
                ...
                <div>
                  ...
                  <p className='mt-4 text-zinc-600 leading-relaxed text-[15px]'>
                    ...
                    dinámico. Una experiencia clave para entender la unión entre
                    el arte visual y la ejecución técnica.
                  </p>
                </div>
              </div>
              <div className='relative'>
